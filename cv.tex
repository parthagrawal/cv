...
\usepackage[xetex,
            ...
            pdfinfo={
              Title={parth/cv},
              Author={Partj Agarwal},
              Subject={Parth Agarwal CV},
              Keywords={web development, android developement, C, Java},
              Producer={xelatex},
              Creator{xelatex}
            },
            ]{hyperref}
...
\par{\centering {\Huge Parth \textsc{Agarwal} }\bigskip\par}
...
\begin{tabularx}{\linewidth}{@{}l X@{}}
  \textsc{Address}     & \small{Mumbai} \\
                       & \small{C/O Groupon, Chicago, IL, 60654-2067} \\
  \textsc{Phone}       & \href{http://www.malloc47.com/call-me/}{9967511320} \\
